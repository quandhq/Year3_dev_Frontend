...
export default function AqiRef({callbackSetSignIn, time_delay})
{
    ...
    return(
        <>
            ...
            <table className='api' style={{ textAlign: 'left', padding: '0px', paddingTop: '3px', paddingBottom: '8px', margin: '0px', borderSpacing: '0px', border: '0px solid black', width: '100%'}} >
            <tr>
                <td className='aqiwgt-table-aqicell' style={{ paddingRight: '5px' }}>
                <div className='aqivalue' id='aqiwgtvalue' style={{ fontSize: '80px', backgroundColor: '#ffde33', color: '#000000' }} title="Moderate">{data["aqi"]}</div>
                </td>
                <td style={{ width: '50%' }} nowrap="true" className='aqiwgt-table-aqiinfo'>
                <div id='aqiwgtinfo' style={{ fontSize: '42px', textShadow: '1px 1px 0 #000000', color: '#ffde33' }}>{data["rating"]["rate"]}</div>
