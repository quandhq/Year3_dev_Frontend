...
const FetchHistory = async (url,callbackSetSignIn) => {
    ...
    console.log(url)
    console.count("useFetch HISTOryyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy start!!!")
    ...
    */
    ...
    const getSensorsData = async (url, access_token) => {
        ...
        console.log("data Histtoryyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy")
        console.log(new_sensors)
        console.log("________________end data history____________________________")
        // setDataHistoryChart(new_sensors)
        if(new_sensors)
        {   
            if(new_sensors.time != time)
            {
    ...
    const getSensors = async () => {
        console.log("inside getTTTTSensordata")
